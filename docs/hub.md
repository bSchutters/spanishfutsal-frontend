...
**Numéros** : l'effectif actif, gardiens puis joueurs de champ, classés par numéro principal, avec les deux numéros de feuille de match que chaque joueur peut porter. Rien à voir avec les numéros affichés sur le site : le club n'a que treize maillots, un numéro se partage entre plusieurs joueurs. La page s'ouvre en affichage. Le bouton **Modifier** ouvre la saisie : toucher un numéro pour le changer, vider la case pour l'effacer, Entrée ou un clic ailleurs enregistre, **Terminer** referme. Les maillots vont du 2 au 14, rien d'autre n'est accepté. Un numéro se donne à deux joueurs au plus, l'un en principal, l'autre en secondaire, jamais à trois : treize maillots, vingt-six places, dix-huit joueurs, donc huit secondaires seulement. Le bloc « Par numéro » liste les treize maillots avec leurs porteurs et les places libres, pour voir où caser les suivants et ne pas donner deux fois le même maillot le même soir. Le staff (coach, kiné) n'y figure pas.
