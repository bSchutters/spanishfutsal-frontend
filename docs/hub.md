...
**Effectif** : toute la collection Joueurs du site, en trois catégories, Gardiens, Joueurs, Staff, les inactifs estompés en fin de catégorie. Chaque ligne montre les deux numéros de feuille de match, la photo et le nom. Toucher une ligne ouvre la fiche : prénom, nom, poste, photo, date de naissance, numéro du site (celui de la page Équipe, rien à voir avec la feuille), numéros de feuille de match, capitaine, actif. Le bouton **Ajouter** crée une fiche. Rien ne se supprime : décocher **Dans l'effectif actuel** sort la personne du site et de la feuille en gardant sa fiche et ses stats.

Les maillots vont du 2 au 14 pour les joueurs de champ, le 1 et le 21 pour les gardiens, rien d'autre n'est accepté. Un numéro se donne à deux joueurs au plus, l'un en principal, l'autre en secondaire, jamais à trois : treize maillots, vingt-six places, donc huit secondaires seulement pour dix-huit joueurs. Le bloc « Maillots » sous la liste dit qui peut porter quel numéro et où il reste de la place.
