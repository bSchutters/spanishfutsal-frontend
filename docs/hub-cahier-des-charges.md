...
| Rapport de diffusion (17/09/2026) | Le rapport de fin de match n est plus pousse vers Discord : Bryan ira le consulter dans le Hub quand il voudra savoir. Le webhook reste en place dans les Paramètres, vide il n envoie rien, et sert de secours. La page du Hub devient l endroit ou les chiffres se lisent, avec la comparaison d un match a l autre que Discord ne pouvait pas donner |
