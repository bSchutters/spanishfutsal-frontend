        ...
        <div className="flex flex-col justify-between lg:w-1/2 w-full gap-6">
          <div className="flex flex-col lg:gap-6 gap-4">
            ...
            <p className="lg:text-xl">
              Furia Roja Futsal est bien plus qu’un simple club de mini foot.
              Fondé à Bruxelles en 2024, il rassemble une équipe de proches,
              composée d’
