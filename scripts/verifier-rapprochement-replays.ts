...
verifie(
  ...
  titre(rapprocher(match('2027-01-16', 'FUTSAL TEAM ANTWERPEN', false), videosAllerRetour)),
...
verifie(
  ...
  titre(
    rapprocher(match('2026-09-12', 'FUTSAL TEAM ANTWERPEN'), [video('Entrainement des U11', '2026-09-13T10:00:00Z')])
  ),
  null
)
